        ...
        <div className={style.movieBottomInfo}>
            <div className={style.upperInfo}>
                ...
                <div className={style.btns}>
                    <div onClick={handleClick} className={style.toQueue} style={isQueueEmpty ? disabledStyles : {}} >
                        Перейти в корзину
                    </div>
                    <AddToQueueBtn item={item} styles={item.serial ? stylesNone : styles}/>
                </div>
            </div>
            <div className={style.bottomInfo}>
                ...
                <div className={style.upper} style={{marginBottom: '3.7313vw'}}>
                    <div className={style.filmName}>
                        ...
                        <div className={style.infoUpperPar}>
                            <div className={style.par}>Формат</div>
                            <div className={style.parDescr}>{item.format}</div>
                        </div>
                    </div>
                </div>
            </div>
